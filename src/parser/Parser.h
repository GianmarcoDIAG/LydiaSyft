 ...
 */
    ...
    private:
        ...
        std::vector<std::vector<std::string>> agent_variables;
        std::vector<std::string> agent_formulas;
        std::string formula;
        bool sys_first;
    ...
    public:
        ...
        */
        ...
        /**
         * \brief Return agent variables in a vector.
         */
        std::vector<std::vector<std::string>> get_agent_variables() const;
         ...
         * \brief Return the formula.
         */
        std::vector<std::string> get_agent_formulas() const;
